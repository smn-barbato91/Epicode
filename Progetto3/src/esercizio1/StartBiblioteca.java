...
public class StartBiblioteca {
	...
	public static void main(String[] args) throws IOException {
		...
		Pubblicazione romanzo3 = new Libro("I556GHDD", "L'ombra dello scorpione", 1991, 900,
				new Autore("Stephen", "King"), "Horror/Fantasy");
...
//		System.out.println(archivio.filtraPerAutore(a)); //E' sufficiente il cognome
		System.out.println(archivio.cercaPerCodice("HGGTERFG"));
